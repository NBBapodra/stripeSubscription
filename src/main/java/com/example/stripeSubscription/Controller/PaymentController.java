package com.example.stripeSubscription.Controller;



import com.example.stripeSubscription.Responce.Response;
import com.example.stripeSubscription.Services.StripeService;
...
public class PaymentController {
    ...
    public @ResponseBody
    Response createSubscription(String email, String token, String coupon) {
        ...
        //create subscription
        String subscriptionId = stripeService.createSubscription(customerId,  coupon);
